...
<body>
    <div class="container">
        ...
        <div class="content">
            <?php
            echo $contact[$language][0];
            ?>
        </div>
    </div>    
    <script src="<?php echo 'http://localhost/PHP_small_projects/Multi-language'; ?>/jquery.min.js"></script>
    <script>
        jQuery(document).ready(function(){           
            jQuery("#language").change(function(){
               var language = jQuery(this).val();
               window.location.href="<?php echo 'http://localhost/PHP_small_projects/Multi-language'; ?>/contacts/"+language;
            });
        });
    </script>
</body>
